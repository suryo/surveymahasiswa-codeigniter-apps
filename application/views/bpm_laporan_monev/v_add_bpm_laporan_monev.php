...
<div class="card card-primary">                    
	...
	<div class="card-body">                    
		...
		echo form_open_multipart('bpm_laporan_monev/bpm_laporan_monev_add') ?>                    
		...
		<div class="form-group">                    
			...
			<input name="tahun_laporan_monev" class="form-control" placeholder="tahun_laporan_monev"                    
				value="<?= set_value('tahun_laporan_monev') ?>">                    
		</div>                    
		<div class="form-group">                    
			<label>Periode Laporan Monev</label> 
			<div class="form-check">
					<input class="form-check-input" value="ganjil" type="radio" name="periode_laporan_monev" checked>
					<label class="form-check-label">Ganjil</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" value="genap" type="radio" name="periode_laporan_monev" >
		...
		<div class="form-group">                    
			...
			<textarea name="deskripsi_laporan_monev" class="form-control" placeholder="deskripsi_laporan_monev"                    
				value="<?= set_value('deskripsi_laporan_monev') ?>">    </textarea>                
		</div>                    
				<div class="form-group">                    
					<label>File</label>                    
