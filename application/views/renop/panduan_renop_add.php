<div class="col-md-12">
	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			echo form_open_multipart('renop/panduan_renop_add') ?>
			<div class="form-group">
				<label>Edisi Renop</label>
				<input name="edisi_renop" class="form-control" placeholder="Edisi Renop"
					value="<?= set_value('edisi_renop') ?>">
			</div>

			<div class="form-group">
				<label>Tahun Renop</label>
				<input name="tahun_renop" class="form-control" placeholder="Tahun Renop"
					value="<?= set_value('tahun_renop') ?>">
			</div>
